...
module.exports = function(error) {
  ...
  var lineLength = ['web-app', 'login_controller', 'mailcheck', 'comment', 'imagecrop','issues_controller','bill_controller','infinite_scroll','issues_post','header_controller','email_connections'];
  ...
  var underscoredFiles = ['header_controller', 'titles', 'bill_controller', 'sign_up_controller', 'directives.js',
    'nav-stick', 'search.js','models/', 'bill_service.js', 'comment_service.js', 'user_service.js', 'controllers/bill_controller.js',];
